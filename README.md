...
First-time run to build it:

```bash
cargo run -- --effect static
```
...
Custom palette with a single selected color:

```bash
./target/debug/Firefly-cli --effect static --colors "#ffffff,#ff8800,#00ffcc,#3366ff,#aa00ff,#ff0066,#88ff00" --ci 1
```
